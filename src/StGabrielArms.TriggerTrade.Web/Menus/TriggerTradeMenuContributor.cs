...
namespace StGabrielArms.TriggerTrade.Web.Menus;

public class TriggerTradeMenuContributor : IMenuContributor
{
    private readonly IConfiguration _configuration;

    public TriggerTradeMenuContributor(IConfiguration configuration)
    {
    ...
    private Task ConfigureMainMenuAsync(MenuConfigurationContext context)
    {
        ...
        var l = context.GetLocalizer<TriggerTradeResource>();

        context.Menu.Items.Insert(
            0,
            new ApplicationMenuItem(
                TriggerTradeMenus.Home,
                l["Menu:Home"],
                "~/",
                icon: "fas fa-home",
                order: 0
